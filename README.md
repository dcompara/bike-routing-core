...
to do this open VS studo Terminal
cd C:\Users\Daniel\Nextcloud\Code\python\gitlab\optimized-road
python -m venv venv
...
python -m ipykernel install --user --name=optimized-road-env
...
Personalized (Subjective) Characteristics:
Diversity
Individualized Time Estimation
Risk
...
Non-Personalized Characteristics:
Distance
Height
Natural Landscape
Solitary Level
Elevation Gain/Steepness
Presence of Light
Proximity to Nature
Distance to Traffic Roads
Nature of Route
Air Quality
Noise Pollution
Data Employed for Profiling
