...
// for the Multi-objective Shortest Path Problem (MOSP)
// @author: sahmadi
// created: 01/11/2023
// updated: 17/06/2024
...
public:
    NWMOA(graph *G, graph *G_rev, experiment exp) : LABEL_Pool_(1024)
    {
...
//// This function initialises the necessary parameters
    ...
    initialise_parameters(graph *G, experiment exp)
    {
        ...
        // initialise lower arrays
        h_ = new cost_t*[num_vertices]();
        // Initialise Expanded_labels for truncated cost_vectors of expanded paths
