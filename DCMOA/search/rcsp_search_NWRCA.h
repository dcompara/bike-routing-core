#ifndef NWRCA_H
#define NWRCA_H
// Unidirectional multi-cost A* Search with Negative Weights
// for the Resource Constrained Shortest Path Problem (RCSP)
// @author: sahmadi
// created: 01/12/2023
// updated: 17/06/2024
...
public:
    NWRCA(graph *G, graph *G_rev, experiment exp) : LABEL_Pool_(1024)
    {
        ...
        {
            // Run backward Dijkstra's algorithm with re-exansions allowed to calculate lower bounds and detect negative cycles
        ...
        // The instance cannot be solved by NWRCA*
        ...
        Multi_search(G, Open_2, LABEL_Pool_, Sol_set_, h_, budgets_,
